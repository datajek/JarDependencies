...
mkdir -p ZookeeperJarDependencies
mkdir -p Tools
...
cp -R /Users/ch.afzal/Personal/Code/DataJek/BigDataCourse/Zookeeper/resources/ZookeeperJarDependencies/* ZookeeperJarDependencies/
